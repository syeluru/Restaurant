...
class TitanFrameworkOptionFontColor extends TitanFrameworkOption {
	...
	public function loadAdminScripts() {
		...
		wp_enqueue_script( 'chosen-admin-script', TP_THEME_URI . 'framework/js/chosen.jquery.min.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_style( 'chosen-admin-style', TP_THEME_URI . 'framework/css/chosen.css' );
	}
