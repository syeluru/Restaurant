...
class TitanFrameworkOptionSave extends TitanFrameworkOption {
	...
	public function display() {
		...
		<p class='submit'>
			<button name="action" value="<?php echo esc_html($this->settings['action']) ?>" class="button button-primary">
				<?php echo ent2ncr($this->settings['save']) ?>
			</button>
			...
			<button name="action" class="button button-secondary"
				...
				<?php echo ent2ncr($this->settings['reset']) ?>
			</button>
			<?php
			endif;
			?>
