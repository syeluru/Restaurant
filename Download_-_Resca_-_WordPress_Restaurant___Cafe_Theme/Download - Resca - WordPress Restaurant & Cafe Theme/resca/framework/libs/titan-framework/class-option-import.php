...
?>
		...
		<p class='submit'>
			...
			if(is_file($demo_data_file)){
			?>
			<img width="300" style="display: none;" id="demodata-thumbnail" src="http://placehold.it/300x200"/><br/>
		...
		<div class="tp_process_bar" style="display:none;">
              ...
              <?php  if (class_exists('RevSlider')) {?>
                <div class="tpimport_slider" style="display: none;">
					...
					<span class="text_note">If import slider don`t finish you can import manual, please view at <a href="http://thimpress.com/knowledge-base/import-revolution-sliders/">here</a></span>
					<div class="tp_process_messase"></div>
				</div>
              <?php }?>
