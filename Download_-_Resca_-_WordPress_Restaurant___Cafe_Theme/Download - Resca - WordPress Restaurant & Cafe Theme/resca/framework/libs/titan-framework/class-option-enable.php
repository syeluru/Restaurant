	...
	class TitanFrameworkOptionEnableControl extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<div class='tf-enable'>
				...
				<span class="button button-<?php echo checked( $this->value(), 1, false ) ? 'primary' : 'secondary' ?>"><?php echo esc_html($this->options['enabled']) ?></span><span class="button button-<?php echo checked( $this->value(), 1, false ) ? 'secondary' : 'primary' ?>"><?php echo esc_html($this->options['disabled']) ?></span>
			</div>
			<?php
